...
public class Books {
	...
	public int compareBookObjects(Book b1,Book b2) {  // int or any datatype returns valuea
		if((b1.bookName).equalsIgnoreCase(b2.bookName)) {
			System.out.println("Book of theis Name Already Exist");
			return 0;
		}
		if(b1.sNo==b2.sNo) {
			System.out.println("Book ooooof this Name Already Exists.");
			return 0;
		}
		return 1;
	}
	public void addBook(Book b) {// void do not returns any value but it may update any preexisting values
